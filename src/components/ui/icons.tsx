...
export function Instagram() {
  return (
    <svg fill="#000000" width="20" className="fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
      <g>
...
export function Facebook() {
  return (
    <svg fill="#000000" width="20" className="fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
